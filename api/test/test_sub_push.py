...
from util import pubsub_msg_from_dict, get_entitlement_response, get_account_response, get_pubsub_event_data
...
class TestPubsub(unittest.TestCase):
    ...
    def test_notification_entitlement_message(self):
        ...
        with patch("api.procurement_api.get_entitlement") as mocked_get_entitlement, \
            ...
            mocked_get_account.return_value = get_account_response()
